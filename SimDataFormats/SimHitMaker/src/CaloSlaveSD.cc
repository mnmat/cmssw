...
bool CaloSlaveSD::processHits(uint32_t unitID, double eDepEM, double eDepHad, double tSlice, math::XYZPoint position, int tkID, uint16_t depth, int parentID) {
  PCaloHit aCal = PCaloHit(unitID, eDepEM, eDepHad, tSlice, tkID, depth, position, parentID);  
